...
public class EditPOstT {

	protected Properties prop = new Properties();
	protected WebDriver driver=new FirefoxDriver();
	String dat = new String();
	String dat2 = new String();
...
//	//done
		@Test
	public void editPOst() throws IOException, AWTException{
		...
		EditPost edit= new EditPost(driver,dat2);
		edit.editpost();
		driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
		Assert.assertTrue(driver.findElement(By.xpath(prop.getProperty("posts"))).getText().contains(dat2));
//		
		driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
		...
		delete.deletePost();
		driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
		 WebElement herbBtn = driver.findElement(By.linkText(dat2));

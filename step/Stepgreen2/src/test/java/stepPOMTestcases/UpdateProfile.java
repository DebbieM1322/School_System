...
import stepConfig.UpdateUProfile;
...
//  //
		...
		public void updateuserProfile () throws IOException{
			...
			UpdateUProfile update= new UpdateUProfile(driver);
			update.updateuserProf();
			Assert.assertTrue(driver.findElement(By.tagName("body")).getText().contains("Τα δεδομένα έχουν ανανεωθεί με επιτυχία"));

...
public class SignUpPassLess6 {

	WebDriver driver;
	protected Properties prop = new Properties();
	    

public SignUpPassLess6(WebDriver driver){
...
public void signup() throws IOException{
	...
	driver.findElement((By.xpath(prop.getProperty("email")))).sendKeys("signuptest" + ran + "@test.com");
	...
	driver.findElement((By.xpath(prop.getProperty("password")))).sendKeys(((prop.getProperty("wrongpass"))));
	driver.findElement((By.xpath(prop.getProperty("confirmpassword")))).sendKeys(((prop.getProperty("wrongpass"))));

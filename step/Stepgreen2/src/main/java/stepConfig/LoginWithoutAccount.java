...
public class LoginWithoutAccount {

	WebDriver driver;
	protected Properties prop = new Properties();
	
	
public LoginWithoutAccount(WebDriver driver){
...
public void typeUsername() throws IOException{
	FileInputStream input=new FileInputStream("config.properties");
	 prop.load(input);
	driver.findElement(By.xpath(prop.getProperty("usernamexpath"))).sendKeys(prop.getProperty("unsmail"));

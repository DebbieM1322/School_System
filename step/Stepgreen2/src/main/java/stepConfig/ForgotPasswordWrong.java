...
public class ForgotPasswordWrong {

	WebDriver driver;
	protected Properties prop = new Properties();
	
	
public ForgotPasswordWrong(WebDriver driver){
...
public void forgotpass() throws IOException{
	...
	driver.findElement(By.xpath(prop.getProperty("forgotp"))).click();
	driver.findElement(By.xpath(prop.getProperty("remindemail"))).sendKeys(prop.getProperty("wrongemail"));
